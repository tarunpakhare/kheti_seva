...
import '/tt4/widget/about_widget.dart';
//import '/main_screen/widgets/topbar_widget.dart';

class t4 extends StatefulWidget {
  //final int i;
  const t4({Key? key, }) : super(key: key);

  @override
  t4State createState() => t4State();
}

class t4State extends State<t4>
            ...
            right: 0,
              ...
              child: AnimatedOpacity(
                ...
                child: SizedBox(
                    ...
                    child: Image.asset('assets/images/t7.jpg')),
              ),
            ),
