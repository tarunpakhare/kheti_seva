...
import 'package:flutter_application_1/ui/appbar/simple_custom_app_bar.dart';
import 'package:flutter_application_1/bloc/suggestions_popup/suggestions_popup_cubit.dart';
import 'package:flutter_application_1/bloc/suggestions_popup/suggestions_popup_state.dart';
import 'package:flutter_application_1/bloc/weather_info/weather_info_cubit.dart';
import 'package:flutter_application_1/bloc/weather_info/weather_info_state.dart';
import 'package:flutter_application_1/helpers/custom_colors.dart';
import 'package:flutter_application_1/helpers/strings.dart';
import 'package:flutter_application_1/ui/widgets/faq_widget.dart';
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            CitiesGrid(
              onDubaiPress: () => {
                cubit.getWeatherByName('state of karnataka'),
                animateToTop(_scrollController)
              },
              onLondonPress: () => {
                cubit.getWeatherByName('state of kerala'),
                animateToTop(_scrollController)
              },
              onNewYorkPress: () => {
                cubit.getWeatherByName('chennai'),
                animateToTop(_scrollController)
              },
              onParisPress: () => {
                cubit.getWeatherByName('amaravathi'),
                animateToTop(_scrollController)
              },
            ),
           /* const FaqScreen(),*/
