...
import '/tt5/widget/about_widget.dart';
//import '/main_screen/widgets/topbar_widget.dart';

class t5 extends StatefulWidget {
  //final int i;
  const t5({Key? key, }) : super(key: key);

  @override
  t5State createState() => t5State();
}

class t5State extends State<t5>
            ...
            right: 0,
              ...
              child: AnimatedOpacity(
                ...
                child: SizedBox(
                    ...
                    child: Image.asset('assets/images/t8.jpg')),
              ),
            ),
