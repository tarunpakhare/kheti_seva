...
import '/tt8/widget/about_widget.dart';
//import '/main_screen/widgets/topbar_widget.dart';

class t8 extends StatefulWidget {
  //final int i;
  const t8({Key? key, }) : super(key: key);

  @override
  t8State createState() => t8State();
}

class t8State extends State<t8>
            ...
            right: 0,
              ...
              child: AnimatedOpacity(
                ...
                child: SizedBox(
                    ...
                    child: Image.asset('assets/images/t4.jpg')),
              ),
            ),
