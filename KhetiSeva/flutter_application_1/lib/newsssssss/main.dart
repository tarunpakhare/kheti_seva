...
class newsAA extends StatefulWidget {
  const newsAA({super.key});

  @override
  _newsAAState createState() => _newsAAState();
}

class _newsAAState extends State<newsAA> {
  dynamic cName;
  dynamic country;
  dynamic category;
  dynamic findNews;
  ...
  Future<void> getNews({
    ...
    if (searchKey != null) {
      ...
      category = null;
      baseApi =
          'https://newsapi.org/v2/top-headlines?pageSize=10&page=$pageNum&q=agriculture&apiKey=58b98b48d2c74d9c94dd5dc296ccf7b6';
    }
    //print(baseApi);
